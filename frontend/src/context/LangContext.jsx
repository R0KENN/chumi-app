...
const STRINGS = {
  en: {
    noPets: 'No pets yet',
    noPetsDesc: 'Create a pair or join with a code!',
    ...
    settings: 'Settings',
    wardrobe: 'Wardrobe',
    wardrobeDesc: 'Outfits coming soon!',
    feed: 'Feed',
    feeding: 'Feeding...',
    fed: 'Fed',
    ...
    joinPair: 'Join a Pair',
    pairCodeLabel: 'Pair code:',
    joining: 'Joining...',
    shopDesc: 'Accessories coming soon!',
    hatched: 'hatched!',
    evolved: 'Evolved:',
    bothFed: 'Both fed today!',
    fedWaiting: 'Fed! Waiting for partner...',
  ...
  ru: {
    ...
    noPetsDesc: 'Создай пару или присоединись по коду!',
    createPair: 'Создать пару',
    join: 'Войти',
    yourPets: 'Твои питомцы',
    home: 'Дом',
    pairs: 'Пары',
    shop: 'Магазин',
    settings: 'Настройки',
    wardrobe: 'Гардероб',
    wardrobeDesc: 'Наряды скоро появятся!',
    feed: 'Покормить',
    feeding: 'Кормлю...',
    fed: 'Покормлен',
    ...
    joinPair: 'Присоединиться',
    pairCodeLabel: 'Код пары:',
    joining: 'Вхожу...',
    shopDesc: 'Аксессуары скоро появятся!',
    hatched: 'вылупился!',
    evolved: 'Эволюция:',
    bothFed: 'Оба покормили сегодня!',
    fedWaiting: 'Покормлен! Жду партнёра...',
...
function detectLanguage() {
  ...
  // Попробуем определить через Telegram
  try {
...
export function LangProvider({ children }) {
  ...
  useEffect(() => {
    localStorage.setItem('chumi_lang', lang);
  }, [lang]);
