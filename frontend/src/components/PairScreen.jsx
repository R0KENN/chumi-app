...
// 40 стикеров из набора @ChumiPetBot — file_id получены через getStickerSet
const CHUMI_STICKERS = [
  { id: 1,  emoji: '🥵', file_id: 'CAACAgIAAxUAAWoD5CLyv9lbxGndn8XSr8BIt5wCAAIkmAACOf4hSCUF3hsSh3eDOwQ' },
  { id: 2,  emoji: '🥵', file_id: 'CAACAgIAAxUAAWoD5CJu1A9edcid2TQVImdF50jJAALjmQACnpAhSPqwTt8g9vyROwQ' },
  { id: 3,  emoji: '😍', file_id: 'CAACAgIAAxUAAWoD5CL7ykzac01Nn7D6FauFBZJxAALmmwACek4gSHTABHUEMrAMOwQ' },
  ...
  { id: 11, emoji: '😎', file_id: 'CAACAgIAAxUAAWoD5CIWmInnlDshlLNapr8S0imFAAIRlgACbMUhSN4P4m8lU66qOwQ' },
  { id: 12, emoji: '🥰', file_id: 'CAACAgIAAxUAAWoD5CKCkMFCS5bgRZ51L1UPmCmZAAITmAACEvwgSGwHFzrmg93bOwQ' },
  { id: 13, emoji: '🫶', file_id: 'CAACAgIAAxUAAWoD5CJdKE-B5AJTm6HCbaEUCjgqAAJrqwACWZohSGWreCeEFhryOwQ' },
  { id: 14, emoji: '😉', file_id: 'CAACAgIAAxUAAWoD5CK4MvN_buir5JhlItF9TrrRAALOnQACkPIgSKBQaebDcUKXOwQ' },
  { id: 15, emoji: '😉', file_id: 'CAACAgIAAxUAAWoD5CIsQUxSuENmOBLmK-0U2sbcAAI9lwACsGkhSAABOVkZJrvOJzsE' },
  { id: 16, emoji: '😇', file_id: 'CAACAgIAAxUAAWoD5CJYVdmDxGu3BHf2-MJW-JHpAALmmwACMrchSO8oq-Myd8qqOwQ' },
  { id: 17, emoji: '😌', file_id: 'CAACAgIAAxUAAWoD5CIZc_Pz6jv6v8ts9U-FXczPAAJanwACe8MhSD5DQAdwbN_vOwQ' },
  { id: 18, emoji: '😘', file_id: 'CAACAgIAAxUAAWoD5CJeFCvS8d0xz-jXJuaW5Tx0AAI1lwACqJIhSIoJgdpMAnxYOwQ' },
  { id: 19, emoji: '💞', file_id: 'CAACAgIAAxUAAWoD5CJpMnpaOlBha9ySNLwxQkdTAAInlgACFdUgSDAffSPYfoH3OwQ' },
  { id: 20, emoji: '🤗', file_id: 'CAACAgIAAxUAAWoD5CJ2hjzKtqEXVenvyaTtaYopAAIxlQACtIsgSM7h0LvKsICWOwQ' },
  { id: 21, emoji: '😏', file_id: 'CAACAgIAAxUAAWoD5CJ7iNNLTlXQ12GWeL-7sWFUAAK6oQACD7cgSI4LMboi19hoOwQ' },
  { id: 22, emoji: '😞', file_id: 'CAACAgIAAxUAAWoD5CKSLbHw66E9fNAsU6Wl7-eWAAKKkwACj7YhSPWC-9L8iU39OwQ' },
  { id: 23, emoji: '❤️', file_id: 'CAACAgIAAxUAAWoD5CJ7Kkc2TnFH9PSq2dHO8mpFAAJ1mgACZgUgSE20L1Df8nhnOwQ' },
  { id: 24, emoji: '😇', file_id: 'CAACAgIAAxUAAWoD5CITONjxFh78S3f81IRI4Ep-AAIjnAACYLsgSLKoKcXCjEFoOwQ' },
  { id: 25, emoji: '😘', file_id: 'CAACAgIAAxUAAWoD5CI5ow4koDkS6-vPIKAfnv24AAK16gACKD0hSPUmnvFPH58DOwQ' },
  { id: 26, emoji: '😋', file_id: 'CAACAgIAAxUAAWoD5CLezcdwlmstM7NYMkcsMA5UAAJxlwAC1C4gSN2EaNzNj3OsOwQ' },
  { id: 27, emoji: '🥸', file_id: 'CAACAgIAAxUAAWoD5CJyaYrg8R89YX4XLhSlJNrjAAKtpgACC44ZSDxFrhBJ4IlQOwQ' },
  { id: 28, emoji: '🎮', file_id: 'CAACAgIAAxUAAWoD5CJVHZnmobNeFSeJz3p0hrECAAKZlgAC2RUhSKmRzlafZ33JOwQ' },
  { id: 29, emoji: '🙂', file_id: 'CAACAgIAAxUAAWoD5CLm9s-l9Fm9O9enuFIkWEGLAAJ-lwACYxcgSO20JrJrcKTZOwQ' },
  { id: 30, emoji: '😯', file_id: 'CAACAgIAAxUAAWoD5CLrHlLeVp0yRrgd1CrQ-yKsAAIWnwACLb4gSFExLjSzeb1NOwQ' },
  { id: 31, emoji: '😡', file_id: 'CAACAgIAAxUAAWoD5CJt2DSqG-lDGsJZVW6d7tm5AAJDogACjTggSK694lBWNAKBOwQ' },
  { id: 32, emoji: '😍', file_id: 'CAACAgIAAxUAAWoD5CJJdkAlRRFkhg2xqcx4j0VqAAJWnQACHH8hSIAr3xFmgxQ_OwQ' },
  { id: 33, emoji: '😴', file_id: 'CAACAgIAAxUAAWoD5CJcdZBlGzauqbBWmUF44HCOAALupgACcAMhSBfZ2TiDvKItOwQ' },
  { id: 34, emoji: '🐝', file_id: 'CAACAgIAAxUAAWoD5CJD0GGGLxMVerwlXPg1Frk6AAIjlAACuyYgSBXOLqmCbR0bOwQ' },
  { id: 35, emoji: '😊', file_id: 'CAACAgIAAxUAAWoD5CIvYlJH-5iRHYuQfNhE4Ng_AAKnmgACFdkgSNsqdp1cQH9IOwQ' },
  { id: 36, emoji: '☕️', file_id: 'CAACAgIAAxUAAWoD5CLlq6tD9Kni9yddxUNhTVY_AAK1pwACp0AgSFZHnjxDPDvROwQ' },
  { id: 37, emoji: '🥰', file_id: 'CAACAgIAAxUAAWoD5CKnJICZK7uojuGbSkgc0PWwAAKrowACeHshSByuI2XuQ0UuOwQ' },
  { id: 38, emoji: '🥲', file_id: 'CAACAgIAAxUAAWoD5CLvAb-KriNcNA0WreJ6COePAALjowACSlUgSF_HOnYSJKQXOwQ' },
  { id: 39, emoji: '🙂', file_id: 'CAACAgIAAxUAAWoDqcZjEG95hVEyrsVkYUl9Q2ULAALwlQACF8khSLCP1tA6P0YqOwQ' },
  { id: 40, emoji: '👋', file_id: 'CAACAgIAAxUAAWoDqcaLmC0ZK9N47B03_aRi3qxAAALPmQACqGEgSE_S91lyNDLaOwQ' },
];
